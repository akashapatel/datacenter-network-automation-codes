...
def read_csv():
    results = []
    with open('CUSTOMER-BD-L2Out.csv', newline='') as csvfile:
...
def main(host, user, password):
    ...
    for lst in resultList: 
        ...
        fvBD = cobra.model.fv.BD(fvTenant, OptimizeWanBandwidth='no', annotation='', arpFlood='yes', descr='',
                                 ...
                                 nameAlias='', ownerKey='', ownerTag='', type='regular', unicastRoute='yes',
                                 unkMacUcastAct='proxy', unkMcastAct='flood', userdom=':all:', v6unkMcastAct='flood',
                                 vmac='not-applicable')
