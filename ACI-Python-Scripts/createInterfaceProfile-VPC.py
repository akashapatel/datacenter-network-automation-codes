...
def read_csv():
    results = []
    with open('CUSTOMER-leaf103-104-interface-profile.csv', newline='') as csvfile:
...
def main(host, user, password):
    ...
    for lst in resultList: 
        ...
        infraRsAccBaseGrp = cobra.model.infra.RsAccBaseGrp(infraHPortS, annotation='', fexId='101', tDn= 'uni/infra/funcprof/accbundle-'+ lst[4], userdom=':all:')
